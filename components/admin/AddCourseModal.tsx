...
export default function AddCourseModal({
  ...
  const [multipartState, setMultipartState] = useState<MultipartState>({
    partNumber: 1,
    completedParts: [],
  });
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a video course and provide course details. Maximum file size:
            1.5GB. Supported formats: MP4, WebM, MOV, AVI.
          </DialogDescription>
        </DialogHeader>
