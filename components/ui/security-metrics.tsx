      ...
      <CardContent className="p-3">
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="flex items-center justify-between">
            <span className="flex items-center gap-1">
              <Lock
                className={`h-3 w-3 ${hasSecureConnection ? "text-green-500" : "text-red-500"}`}
              />
              Secure Connection
            </span>
            <span
              className={
                hasSecureConnection ? "text-green-600" : "text-red-600"
              }
            >
          ...
          <div className="flex items-center justify-between">
            <span className="flex items-center gap-1">
              <Clock
                className={`h-3 w-3 ${rateLimitRemaining > 2 ? "text-green-500" : "text-orange-500"}`}
              />
              Rate Limit
            </span>
            <span
              className={
                rateLimitRemaining > 2 ? "text-green-600" : "text-orange-600"
              }
            >
