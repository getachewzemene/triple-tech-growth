...
const TeamSection = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description:
        "Tech visionary with a focus on product development and innovation.",
    ...
    },
    {
      ...
      name: "Dagim Wondale",
      description:
        "Marketing guru with a knack for driving brand growth and engagement.",
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Meet the passionate professionals behind Triple Technologies'
            success
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${member.bgGradient} opacity-0 group-hover:opacity-60 transition-all duration-500 pointer-events-none z-0`}
              ></div>
              ...
              <div className="relative z-20 p-8">
                ...
                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                  <div
                    className={`px-3 py-1 rounded-full bg-gradient-to-r ${member.gradient} text-white text-xs font-semibold`}
                  >
                    {member.experience}
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <h4
                      className={`text-lg font-semibold bg-gradient-to-r ${member.gradient} bg-clip-text text-transparent mb-3`}
                    >
                      {member.title}
                    </h4>
                ...
                {/* Expertise */}
                <div className="mb-6">
                  <h5 className="text-sm font-semibold text-gray-800 mb-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
                    Expertise:
                  </h5>
              ...
              <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div
                  className="absolute top-1/4 left-1/4 w-2 h-2 bg-yellow-400 rounded-full animate-bounce"
                  style={{ animationDelay: "0s" }}
                ></div>
                <div
                  className="absolute top-3/4 right-1/4 w-1 h-1 bg-blue-400 rounded-full animate-pulse"
                  style={{ animationDelay: "1s" }}
                ></div>
                <div
                  className="absolute bottom-1/3 left-3/4 w-1.5 h-1.5 bg-purple-400 rounded-full animate-bounce"
              ...
              <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-0">
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${member.gradient} opacity-20 blur-xl transform scale-110`}
                ></div>
              </div>
            </div>
          ))}
