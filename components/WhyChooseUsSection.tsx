...
import { Lightbulb, Award, HeadphonesIcon, Sparkles, TrendingUp, Shield } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      stats: '100+ Projects',
      features: ['AI Integration', 'Modern Frameworks', 'Future-Ready Solutions']
    },
    {
      icon: Award,
      title: 'Expertise',
      ...
      stats: '5+ Years',
      features: ['Certified Professionals', 'Industry Standards', 'Best Practices']
    },
    {
      icon: HeadphonesIcon,
      title: 'Support',
      ...
      features: ['Instant Response', 'Proactive Monitoring', 'Continuous Updates']
    }
  ];
  ...
  return (
    <section id="why-choose-us" ref={sectionRef} className="py-20 bg-gradient-to-br from-gray-50 via-white to-slate-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-yellow/10 to-light-blue/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-light-blue/10 to-yellow/10 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-gray-600">Why Choose Triple Technologies</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-light-blue to-yellow">Choose Us</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
          {benefits.map((benefit, index) => (
            <div
              key={benefit.title}
              className={`group relative overflow-hidden rounded-3xl bg-white backdrop-blur-sm border border-gray-100 hover:border-gray-200 transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 ${benefit.shadowColor} hover:shadow-2xl cursor-pointer ${
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <div className="relative mb-6">
                  <div className={`p-4 rounded-2xl bg-gradient-to-br ${benefit.gradient} group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg inline-block`}>
                ...
                <div className="space-y-2">
                  {benefit.features.map((feature, idx) => (
                    ...
                    >
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${benefit.gradient} animate-pulse`}></div>
              ...
              <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                <div className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${benefit.gradient} opacity-20 blur-xl transform scale-110`}></div>
              </div>
            </div>
          ))}
        </div>
