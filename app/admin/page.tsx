...
function AdminPageContent() {
  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      {/* Key Metrics Cards */}
  <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 gap-4 xs:gap-4 sm:gap-6">
        <Card>
                          ...
                          {courseEntries.map(([cid, list]) => {
                            ...
                            return (
                              <div key={cid} className="border rounded-md p-3">
                                ...
                                <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-2 xs:gap-2">
                                  {list
                                    .sort((a, b) => a.order - b.order)
                                    .map((topic: any) => (
                                      <div
